...
export class UserListComponent implements OnInit {
  ...
  editingUser: User | null = null; // Track user currently being edited
  ...
  //isConfirmDialogVisible = false; // Track confirmation dialog visibility
